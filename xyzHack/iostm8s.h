...
volatile char ADC_HTRH      @0x5408;	/* ADC high threshold register high */
volatile char ADC_HTRL      @0x5409;	/* ADC high threshold register low */
volatile char ADC_LTRH      @0x540a;	/* ADC low threshold register high */
volatile char ADC_LTRL      @0x540b;	/* ADC low threshold register low */
volatile char ADC_AWSRH     @0x540c;	/* ADC analog watchdog status register high */
volatile char ADC_AWSRL     @0x540d;	/* ADC analog watchdog status register low */
volatile char ADC_AWCRH     @0x540e;	/* ADC analog watchdog control register high */
volatile char ADC_AWCRL     @0x540f;	/* ADC analog watchdog control register low */
